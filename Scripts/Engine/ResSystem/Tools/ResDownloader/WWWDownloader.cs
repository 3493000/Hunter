...
namespace Hunter
{
    ...
    public class WWWDownloader : TMonoSingleton<WWWDownloader>, IHttpDownloader
    {
        ...
        private OnDownloadFinished m_OnFinished;
        private OnDownloadError m_OnError;
        private OnDownloadProgress m_OnProgress;
        private OnDownloadBegin m_OnDownloadBegin;
        private OnDownloadValidCheck m_OnValidCheck;
        private WWW m_WWW;

        protected float m_PreSize;
        protected long m_LastChangeTime;
        protected int m_FileSize;
        protected bool m_LogError;
        ...
        private IEnumerator StartIEnumeratorTask()
        {
            ...
            if (m_WWW.error != null)
            {
                ...
                else
                {
                    ...
                    HandleEvent(DownloadEvent.Error, "");
                }
        ...
        private void SavaFileFromMemory()
        {
            ...
            try
            {
                ...
                if (m_OnValidCheck != null)
                {
                    if (!m_OnValidCheck(msg))
                    {
                        HandleEvent(DownloadEvent.Error, "Raw Data Invalid.");
                        return;
                    }
                }
