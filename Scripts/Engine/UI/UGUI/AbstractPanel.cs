...
namespace Hunter
{
    ...
    public class AbstractPanel : AbstractPage
    {
        ...
        */
        [SerializeField]
        protected PanelHideMask m_HideMask = PanelHideMask.None;
        [SerializeField]
        protected bool          m_CustomVisibleFlag = true;
        [SerializeField]
        protected int           m_SortingOrder = -1;
        protected bool          m_HasStart = false;
        protected int           m_MaxSortingOrder = -1;
        protected bool          m_IsOrderDirty = false;
        protected int           m_LastOpenFrame = -1;
        ...
        public bool isOrderDirty
        {
            get { return m_IsOrderDirty; }
        }
