...
namespace Hunter
{
    public class TableReadThreadWork
    {
        class TableInfo
        {
            ...
            public TableInfo(Hunter.DTableOnParse parseRun, string fileName)
            {
        ...
        public void AddJob(string tableName, Hunter.DTableOnParse onParse = null)
        {
            if (onParse == null)
            {
                return;
        ...
        public static void ReadSync(Hunter.DTableOnParse onParse, string fileName)
        {
